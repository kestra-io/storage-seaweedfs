...
> Use [SeaweedFS](https://github.com/seaweedfs/seaweedfs) as internal storage backend for your Kestra workflows. Store and retrieve workflow data using a fast, distributed object store.
